...
struct DownloadButtonVideo: View {
...
// MARK: - Description
                      ...
                      VStack(alignment: .leading, spacing: 0) {
                          Text(downloadManager.isDownloaded ? "Delete downloaded video" : "Watch offline")
                              .font(.caption2)
...
struct DownloadButtonVideo_Previews: PreviewProvider {
